...
using EmpleadosApp.Core.Options;
...
builder.Services.AddCors(options =>
{
    options.AddPolicy(name: allowSpecificOrigins,
                      policy =>
                      {
                          policy.WithOrigins(origins);// Permitir cualquier origen
...
builder.Services.AddDbContext<IdentityDBContext>(options =>
{
    ...
    options.UseSqlServer(connString, b => b.MigrationsAssembly("EmpleadosApp.API"));
});
